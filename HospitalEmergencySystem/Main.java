...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("3. Display All Patient Records (BST)");
            System.out.println("4. Add Patient to Emergency Queue (Queue)");
            System.out.println("5. Call Patient for Treatment (Queue -> Stack)");
            System.out.println("6. Display Emergency Queue (Queue)");
            System.out.println("7. Undo Last Treatment (Stack)");
            System.out.println("8. Display Treatment History (Stack)");
            System.out.println("9. Add Visit Record (Linked List)");
            System.out.println("10. Display Visit History (Linked List)");
